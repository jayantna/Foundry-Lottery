...
This project is a smart contract lottery built using Foundry, showcasing the integration of Chainlink VRF for randomness and automation. It provides a comprehensive guide for setting up, deploying, and testing the lottery contract on Ethereum testnets.
...
- [Foundry Smart Contract Lottery](#foundry-smart-contract-lottery-1)
